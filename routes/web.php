...
Route::middleware(['auth'])->group(function (){
    ...
    Route::middleware(['role:superadmin,admin,pengurus,anggota'])->group(function(){
        ...
        Route::get('profil/edit',[AnggotaController::class, 'editprofil'])->name('anggota.editprofil');
        Route::patch('profil/edit',[AnggotaController::class, 'updateprofil'])->name('anggota.updateprofil');
        ...
        Route::get('ganti-password', [AnggotaController::class, 'gantiPassword'])->name('anggota.gantipassword');
        Route::patch('ganti-password', [AnggotaController::class, 'updatePassword'])->name('anggota.updatepassword');
