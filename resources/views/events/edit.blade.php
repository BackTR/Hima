<x-app-sidebar>
    ...
    <x-slot name="breadcrumb">Home / Event / Edit</x-slot>
        ...
        <form action="{{ route('events.update', $event->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="mb-4 md:col-span-2">
                    ...
                    <textarea name="deskripsi" rows="4" class="mt-1 block w-full bg-gray-700 border border-gray-600 rounded p-2 text-white">{{ old('deskripsi', $event->deskripsi) }}</textarea>
                </div>
